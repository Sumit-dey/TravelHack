...
function EditListing() {
    ...
    const [aboutThePlace, setAboutThePlace] = useState(spot?.aboutThePlace)
    ...
    useEffect(() => {
        if (spot) {
            ...
            setAboutThePlace(spot?.aboutThePlace)
            setPrice(spot?.price)
        }
    }, [spot])
    ...
    const updateAboutThePlace = (e) => setAboutThePlace(e.target.value);
